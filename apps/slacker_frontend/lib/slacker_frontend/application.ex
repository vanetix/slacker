defmodule SlackerFrontend.Application do
  use Application
  ...
  def start(_type, _args) do
    ...
    children = [
      ...
      supervisor(SlackerFrontendWeb.Endpoint, []),
      # Start your own worker by calling: SlackerFrontend.Worker.start_link(arg1, arg2, arg3)
  ...
  def config_change(changed, _new, removed) do
    SlackerFrontendWeb.Endpoint.config_change(changed, removed)
    :ok
  end
end
